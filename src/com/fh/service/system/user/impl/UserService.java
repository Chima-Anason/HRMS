...
public class UserService implements UserManager{
	 ...
	 * @throws Exception
	 */
	public void editMyU(PageData pd)throws Exception{
		dao.update("UserMapper.editMyU", pd);
	}
	...
	/**Lists of user for training
	 * @param pd
	 * @return
	 * @throws Exception
	 */
	@SuppressWarnings("unchecked")
	public List<User> listAllUsers(PageData pd) throws Exception {
		return (List<User>) dao.findForList("UserMapper.listAllUsers", pd);
	}
