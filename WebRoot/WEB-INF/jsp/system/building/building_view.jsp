						...
						<div class="col-xs-12">
								<form action="building/${msg }.do" name="buildingForm" id="buildingForm" method="post">
									...
									<table id="table_report" class="table table-striped table-bordered table-hover">
										...
										<tr>
											<td style="width:79px;text-align: right;padding-top: 13px;">楼宇具体名称:</td>
											<td><input type="text" name="BUILDING_NAME" id="building_name" value="${null==pd?'无此楼宇具体名称':pd.BUILDING_NAME }" maxlength="32" title="楼宇具体名称" style="width:98%;" disabled="disabled"/></td>
										</tr>
										<tr>
											<td style="width:79px;text-align: right;padding-top: 13px;">楼宇具体编号:</td>
											<td><input type="text" name="BUILDING_NO" id="BUILDING_NO" value="${pd.BUILDING_NO }" maxlength="32" title="楼宇具体编号" onblur="hasN('${pd.BUILDING_NO }')" style="width:98%;" disabled="disabled"/></td>
										</tr>
