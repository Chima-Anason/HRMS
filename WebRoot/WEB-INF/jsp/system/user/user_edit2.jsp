				...
				<div class="row">
					...
					<form action="user/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
						    <tr>
							    <td style="width:75px;text-align: right;padding-top: 13px;">主职角色:</td>
								...
								<td><input type="text" name="USERNAME" id="loginname" value="${pd.USERNAME}" maxlength="50" placeholder="这里输入用户名" title="用户名" style="width:98%;"/></td>
