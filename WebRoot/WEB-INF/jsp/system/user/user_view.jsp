								...
								<form action="user/${msg }.do" name="userForm" id="userForm" method="post">
									...
									<table id="table_report" class="table table-striped table-bordered table-hover">
										...
										<tr>
											...
											<td><input type="text" name="BIANMA" id="BIANMA" value="${pd.BIANMA }" maxlength="32" title="编号" onblur="hasN('${pd.USERNAME }')" style="width:98%;" disabled="disabled"/></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><input type="number" name="TEL" id=""TEL""  value="${pd.TEL }"  maxlength="32" title="手机号" style="width:98%;" disabled="disabled"/></td>
										</tr>
										<tr>
