...
<body>
	...
	<div style="width:100%;text-align: center;margin: 0 auto;position: absolute;">
		...
		<div id="loginbox" >
				...
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							...
							</span><input type="text" name="loginname" id="loginname" value="" placeholder="please enter your username" />
						</div>
					</div>
				</div>
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							...
							<!-- </span><input type="password" name="password" id="password" placeholder="please enter your password" class="keypad" keypadMode="full" allowKeyboard="true" value=""/> -->
							</span><input type="password" name="password" id="password" value="" placeholder="please enter your password" />
						</div>
					</div>
				</div>
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">Copyright ©ANAGRACE TECH  2021</span></font>
				</div>
			</div>
		</div>
		</div>
			...
			<form action="" method="post" name="loginForm2" id="loginForm2">
				...
				<div class="form-actions">
					<div style="width:90%;padding-left:5%;">
						...
						<span class="pull-right" style="padding-right:3%;"><a href="javascript:changepage(2);" class="btn btn-success">cancel</a></span>
						<span class="pull-right"><a onclick="register();" class="flip-link btn btn-info" id="to-recover">submit</a></span>
					</div>
				</div>
			</form>
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">Copyright ©CHIMA Tblynxx 2021</span></font>
				</div>
			</div>
		</div>
		</div>
	...
	<div id="templatemo_banner_slide" class="container_wapper">
		<div class="camera_wrap camera_emboss" id="camera_slide">
			...
			<c:choose>
				...
				<c:otherwise>
					<div data-src="static/login/images/MyBanner6.jpg"></div>
					<div data-src="static/login/images/MyBanner7.jpg"></div>
					<div data-src="static/login/images/MyBanner3.jpg"></div>
					<div data-src="static/login/images/MyBanner4.jpg"></div>
