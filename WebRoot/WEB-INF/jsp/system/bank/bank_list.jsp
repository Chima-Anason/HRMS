						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center">银行账户名</th>
									<th class="center">银行名</th>
										...
										<tr>
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													...
													<a class="btn btn-xs btn-info" title="绑定用户" onclick="userBinding('${var.BANK_ID}');">
													...
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															<c:if test="${QX.userBinding == 1 }">
															<li>
																<a style="cursor:pointer;" onclick="userBinding('${var.BANK_ID}');" class="tooltip-warning" data-rel="tooltip" title="绑定用户">
																	<span class="blue">
																		<i class="ace-icon glyphicon glyphicon-user"></i>
																	</span>
																</a>
	...
	<script type="text/javascript">
		...
		function makeAll(msg){
			bootbox.confirm(msg, function(result) {
				...
				//打开绑定用户窗口
		function userBinding(BANK_ID){
			 top.jzts();
			 var diag = new top.Dialog();
			 diag.Drag=true;
			 diag.Title ="绑定登录用户";
			 diag.URL = '<%=basePath%>user/listUsersForWindow.do?BANK_ID='+BANK_ID;
			 diag.Width = 700;
			 diag.Height = 545;
			 ...
			 diag.CancelEvent = function(){ //关闭事件
				 ...
				 if("" != USERNAME){
					var url = "<%=basePath%>bank/userBinding.do?BANK_ID="+BANK_ID+"&USER_ID="+USERNAME+"&tm="+new Date().getTime();
					$.get(url,function(data){
						$("#fhadmincz").tips({
							side:1,
				            msg:'绑定成功',
