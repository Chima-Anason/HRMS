	...
	<div class="main-container" id="main-container">
		...
		<div class="main-content">
			<div class="main-content-inner">
					<!-- 检索  -->
					<form action="headman/listfortc.do" method="post" name="Form" id="Form">
						...
						<tr>
							<td>
								...
								<span class="input-icon">
									<input autocomplete="off" class="nav-search-input"  id="nav-search-input" type="text" name="keywords"  value="${pd.keywords}" placeholder="这里输入关键词" />
								</span>
								</div>
							</td>
							<c:if test="${QX.cha == 1 }">
								...
								<c:forEach items="${varList}" var="var" varStatus="vs">
									<tr>
										...
										<td class="center" style="width:130px;">
											<a class="btn btn-xs btn-info" title="选择" onclick="xuanTp('${var.HEADMAN_NO}');">选择 </a>
										</td>
									</tr>
