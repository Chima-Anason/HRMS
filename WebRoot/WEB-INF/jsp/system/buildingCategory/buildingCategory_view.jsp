		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
								<form action="buildingCategory/${msg }.do" name="buildingCategoryForm" id="buildingCategoryForm" method="post">
									...
									<table id="table_report" class="table table-striped table-bordered table-hover">
										...
										<tr>
											<td style="width:79px;text-align: right;padding-top: 13px;">楼宇类别编号:</td>
											<td><input type="text" name="CATEGORY_ORDER" id="category_order" value="${null==pd?'无此楼宇类别编号':pd.CATEGORY_ORDER }" maxlength="32" title="楼宇类别编号" style="width:98%;" disabled="disabled"/></td>
										</tr>
										<tr>
											<td style="width:79px;text-align: right;padding-top: 13px;">楼宇类别名称:</td>
											<td><input type="text" name="CATEGORY_NAME" id="CATEGORY_NAME" value="${pd.CATEGORY_NAME }" maxlength="32" title="楼宇类别名称" onblur="hasN('${pd.CATEGORY_NAME }')" style="width:98%;" disabled="disabled"/></td>
										</tr>
									
										<%-- <tr>
											<td style="width:79px;text-align: right;padding-top: 13px;">上次楼宇名称:</td>
											<td><input type="text" name="LAST_BUILDING_NAME" id="LAST_BUILDING_NAME"  value="${pd.LAST_BUILDING_NAME }"  maxlength="32" title="上次楼宇名称" style="width:98%;" disabled="disabled"/></td>
										</tr>
...
<script type="text/javascript">
	...
	function hasN(CATEGORY_NAME){
		...
		$.ajax({
			type: "POST",
			url: '<%=basePath%>buildingCategory/hasN.do',
